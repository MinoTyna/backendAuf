...
from .views import ProduitCreateAPIView,ProduitActivateAPIView, ProduitListAPIView,ProduitDeleteAPIView,ProduitUpdateAPIView,ProduitTotalAPIView
...
urlpatterns = [
    ...
    path('active/<int:produit_id>/', ProduitActivateAPIView.as_view(), name='activate-produit'),
